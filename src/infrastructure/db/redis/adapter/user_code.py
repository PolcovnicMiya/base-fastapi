...
from src.infrastructure.db.redis.ports import EmailCodeRedisRepositoryPort

class EmailCodeRedisRepositoryAdapter(EmailCodeRedisRepositoryPort):
    ...
    async def set_one_code(self, email: str , * , code:str) -> None:
        ...
        await self._redis.set(
            name=key,
            value=value,
            ex=Environments().email_code.EMAIL_CODE_LIFETIME
        )
